...
<html>
    ...
    <body>
        ...
        <div id="show-dataRequest" class="content scaffold-show" role="main">
            ...
            <f:display bean="dataRequest" />
            <g:form resource="${this.dataRequest}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.dataRequest}"><g:message code="default.button.edit.label" default="Edit" /></g:link>

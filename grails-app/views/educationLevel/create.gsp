...
<html>
    ...
    <body>
        <a href="#create-educationLevel" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
        ...
        <div id="create-educationLevel" class="content scaffold-create" role="main">
            ...
            <g:form resource="${this.educationLevel}" method="POST">
                <fieldset class="form">
